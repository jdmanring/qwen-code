---
name: bugfix
description: Triggers a reproduce-first workflow to resolve bugs reported via GitHub issues.
category: qc
---
...
1.  **Issue Capture**:
    ...
    - Creates a local tracking file at `.mega-context/issues/issue-<number>.md`. This file serves as the single source of truth to maintain context and minimize token usage.
2.  **Reproduction**:
...
- **Output**:
    ...
    - A completed `.mega-context/issues/issue-<number>.md` file containing both reproduction and verification reports.

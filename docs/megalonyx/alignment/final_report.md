...
| **Extraction** | **Agentic**: LLM analyzes chat to extract facts | **Atomic**: Simple ingest of provided text |  **Gap** |
| **Dreaming** | **Agentic**: LLM synthesizes & consolidates | **Systemic**: Basic hash-based deduplication |  **Gap** |

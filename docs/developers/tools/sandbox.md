...
#### 1Clone qwen code project first, https://github.com/QwenLM/qwen-code.git

#### 2Make sure you perform the following operation in the source code repository directory
...
#### 3Create your sandbox Dockerfile under the root directory of your own project
...
#### 4Create the first sandbox image under the root directory of your project

...
// Deutsche bersetzungen fr Qwen Code CLI
...
export default {
  ...
  // ============================================================================
  // Attachment hints
  ' to manage attachments': ' Anhnge verwalten',
  '<- -> select, Delete to remove,  to exit':
    '<- -> auswhlen, Delete zum Lschen,  beenden',
  'Attachments: ': 'Anhnge: ',
  'Basics:': 'Grundlagen:',
  'Add context': 'Kontext hinzufgen',
  'Use {{symbol}} to specify files for context (e.g., {{example}}) to target specific files or folders.':
    'Verwenden Sie {{symbol}}, um Dateien als Kontext anzugeben (z.B. {{example}}), um bestimmte Dateien oder Ordner auszuwhlen.',
  '@': '@',
  ...
  'Execute shell commands via {{symbol}} (e.g., {{example1}}) or use natural language (e.g., {{example2}}).':
    'Shell-Befehle ber {{symbol}} ausfhren (z.B. {{example1}}) oder natrliche Sprache verwenden (z.B. {{example2}}).',
  '!': '!',
  ...
  'Keyboard Shortcuts:': 'Tastenkrzel:',
  'Jump through words in the input': 'Wrter in der Eingabe berspringen',
  'Close dialogs, cancel requests, or quit application':
    'Dialoge schlieen, Anfragen abbrechen oder Anwendung beenden',
  'New line': 'Neue Zeile',
  'New line (Alt+Enter works for certain linux distros)':
    'Neue Zeile (Alt+Enter funktioniert bei bestimmten Linux-Distributionen)',
  'Clear the screen': 'Bildschirm lschen',
  ...
  "Press 'i' for INSERT mode and 'Esc' for NORMAL mode.":
    "Drcken Sie 'i' fr den EINFGE-Modus und 'Esc' fr den NORMAL-Modus.",
  'Cancel operation / Clear input (double press)':
    'Vorgang abbrechen / Eingabe lschen (doppelt drcken)',
  'Cycle approval modes': 'Genehmigungsmodi durchschalten',
  'Cycle through your prompt history': 'Eingabeverlauf durchblttern',
  'For a full list of shortcuts, see {{docPath}}':
    'Eine vollstndige Liste der Tastenkrzel finden Sie unter {{docPath}}',
  'docs/keyboard-shortcuts.md': 'docs/keyboard-shortcuts.md',
  'for help on Qwen Code': 'fr Hilfe zu Qwen Code',
  ...
  'Analyzes the project and creates a tailored QWEN.md file.':
    'Analysiert das Projekt und erstellt eine mageschneiderte QWEN.md-Datei.',
  'List available Qwen Code tools. Usage: /tools [desc]':
    'Verfgbare Qwen Code Werkzeuge auflisten. Verwendung: /tools [desc]',
  'List available skills.': 'Verfgbare Skills auflisten.',
  'Available Qwen Code CLI tools:': 'Verfgbare Qwen Code CLI-Werkzeuge:',
  'No tools available': 'Keine Werkzeuge verfgbar',
  'View or change the approval mode for tool usage':
    'Genehmigungsmodus fr Werkzeugnutzung anzeigen oder ndern',
  'View or change the language setting':
    'Spracheinstellung anzeigen oder ndern',
  'List background tasks (text dump -- interactive dialog opens via the footer pill)':
    'Hintergrundaufgaben auflisten (Textausgabe; der interaktive Dialog lsst sich ber die Schaltflche in der Fuzeile ffnen)',
  'Delete a previous session': 'Eine frhere Sitzung lschen',
  'Run installation and environment diagnostics':
    'Installations- und Umgebungsdiagnosen ausfhren',
  'Browse dynamic model catalogs and choose which models stay enabled locally':
    'Dynamische Modellkataloge durchsuchen und auswhlen, welche Modelle lokal aktiviert bleiben',
  'Generate a one-line session recap now':
    'Jetzt eine einzeilige Sitzungszusammenfassung erstellen',
  'Rename the current conversation. --auto lets the fast model pick a title.':
    'Die aktuelle Unterhaltung umbenennen. Mit --auto lsst du das schnelle Modell einen Titel whlen.',
  'Rewind conversation to a previous turn':
    'Die Unterhaltung auf einen frheren Gesprchsschritt zurcksetzen',
  'Rewind Conversation': 'Unterhaltung zurckspulen',
  'No user turns to rewind to.': 'Keine Benutzerrunden zum Zurckspulen.',
  'Rewind to: ': 'Zurckspulen zu: ',
  ...
  'Never mind': 'Egal',
  'Computing file changes...': 'Dateinderungen werden berechnet...',
  ...
  'Rewind failed: {{error}}': 'Zurckspulen fehlgeschlagen: {{error}}',
  'Cannot rewind conversation: no active model client.':
    'Konversation kann nicht zurckgespult werden: kein aktiver Modell-Client.',
  'Code restored, but conversation could not be rewound (no active client).':
    'Code wiederhergestellt, aber Konversation konnte nicht zurckgespult werden (kein aktiver Client).',
  'Conversation rewound. Edit your prompt and press Enter to continue.':
    'Konversation zurckgespult. Bearbeite deinen Prompt und drcke Enter, um fortzufahren.',
  'Rewinding does not affect files edited manually or via shell commands.':
    'Das Zurckspulen wirkt sich nicht auf Dateien aus, die manuell oder per Shell-Befehl gendert wurden.',
  'Cannot rewind to a turn that was compressed. Try a more recent turn.':
    'Zu einem komprimierten Turn kann nicht zurckgespult werden. Bitte einen aktuelleren Turn versuchen.',
  'File restore is unavailable for this turn (no captured file changes, or this turn predates the current session).':
    'Datei-Wiederherstellung ist fr diesen Turn nicht verfgbar (keine erfassten Dateinderungen, oder dieser Turn liegt vor der aktuellen Sitzung).',
  ...
  'Cannot restore files: this turn was created before file checkpointing was enabled.':
    'Dateien knnen nicht wiederhergestellt werden: Dieser Turn wurde erstellt, bevor Datei-Checkpointing aktiviert war.',
  'No files needed to be restored.':
    'Keine Dateien mussten wiederhergestellt werden.',
  ' to navigate  Enter to select  Esc to go back':
    ' navigieren  Enter auswhlen  Esc zurck',
  ' to navigate  Enter to select  Esc to cancel':
    ' navigieren  Enter auswhlen  Esc abbrechen',
  'Enter/Y to confirm  Esc/N to go back': 'Enter/Y besttigen  Esc/N zurck',
  'change the theme': 'Design ndern',
  'Select Theme': 'Design auswhlen',
  Preview: 'Vorschau',
  '(Use Enter to select, Tab to configure scope)':
    '(Enter zum Auswhlen, Tab zum Konfigurieren des Bereichs)',
  '(Use Enter to apply scope, Tab to go back)':
    '(Enter zum Anwenden des Bereichs, Tab zum Zurckgehen)',
  'Theme configuration unavailable due to NO_COLOR env variable.':
    'Design-Konfiguration aufgrund der NO_COLOR-Umgebungsvariable nicht verfgbar.',
  'Theme "{{themeName}}" not found.': 'Design "{{themeName}}" nicht gefunden.',
  'Theme "{{themeName}}" not found in selected scope.':
    'Design "{{themeName}}" im ausgewhlten Bereich nicht gefunden.',
  'Clear conversation history and free up context':
    'Gesprchsverlauf lschen und Kontext freigeben',
  'Compresses the context by replacing it with a summary.':
    'Komprimiert den Kontext durch Ersetzen mit einer Zusammenfassung.',
  'open full Qwen Code documentation in your browser':
    'Vollstndige Qwen Code Dokumentation im Browser ffnen',
  'Configuration not available.': 'Konfiguration nicht verfgbar.',
  ...
  'Manage subagents for specialized task delegation.':
    'Unteragenten fr spezialisierte Aufgabendelegation verwalten.',
  'Manage existing subagents (view, edit, delete).':
    'Bestehende Unteragenten verwalten (anzeigen, bearbeiten, lschen).',
  'Create a new subagent with guided setup.':
    'Neuen Unteragenten mit gefhrter Einrichtung erstellen.',

  // ============================================================================
  // Agents - Management Dialog
  // ============================================================================
  Agents: 'Agenten',
  'Choose Action': 'Aktion whlen',
  'Edit {{name}}': '{{name}} bearbeiten',
  'Edit Tools: {{name}}': 'Werkzeuge bearbeiten: {{name}}',
  'Edit Color: {{name}}': 'Farbe bearbeiten: {{name}}',
  'Delete {{name}}': '{{name}} lschen',
  'Unknown Step': 'Unbekannter Schritt',
  'Esc to close': 'Esc zum Schlieen',
  'Enter to select,  to navigate, Esc to close':
    'Enter zum Auswhlen,  zum Navigieren, Esc zum Schlieen',
  'Esc to go back': 'Esc zum Zurckgehen',
  'Enter to confirm, Esc to cancel': 'Enter zum Besttigen, Esc zum Abbrechen',
  'Enter to select,  to navigate, Esc to go back':
    'Enter zum Auswhlen,  zum Navigieren, Esc zum Zurckgehen',
  'Enter to submit, Esc to go back': 'Enter zum Absenden, Esc zum Zurckgehen',
  'Invalid step: {{step}}': 'Ungltiger Schritt: {{step}}',
  ...
  'Delete Agent': 'Agent lschen',
  Back: 'Zurck',
  'No agent selected': 'Kein Agent ausgewhlt',
  'File Path: ': 'Dateipfad: ',
  'Tools: ': 'Werkzeuge: ',
  'Color: ': 'Farbe: ',
  ...
  'Are you sure you want to delete agent "{{name}}"?':
    'Sind Sie sicher, dass Sie den Agenten "{{name}}" lschen mchten?',
  // ============================================================================
  ...
  'Step {{n}}: Choose Location': 'Schritt {{n}}: Speicherort whlen',
  'Step {{n}}: Choose Generation Method':
    'Schritt {{n}}: Generierungsmethode whlen',
  'Generate with Qwen Code (Recommended)':
    'Mit Qwen Code generieren (Empfohlen)',
  'Manual Creation': 'Manuelle Erstellung',
  'Describe what this subagent should do and when it should be used. (Be comprehensive for best results)':
    'Beschreiben Sie, was dieser Unteragent tun soll und wann er verwendet werden soll. (Ausfhrliche Beschreibung fr beste Ergebnisse)',
  'e.g., Expert code reviewer that reviews code based on best practices...':
    'z.B. Experte fr Code-Reviews, der Code nach Best Practices berprft...',
  ...
  'Step {{n}}: Select Tools': 'Schritt {{n}}: Werkzeuge auswhlen',
  ...
  'Read & Edit & Execution Tools':
    'Lese-, Bearbeitungs- und Ausfhrungswerkzeuge',
  'All tools selected, including MCP tools':
    'Alle Tools ausgewhlt, einschlielich MCP tools',
  'Selected tools:': 'Ausgewhlte Werkzeuge:',
  'Read-only tools:': 'Nur-Lese-Werkzeuge:',
  'Edit tools:': 'Bearbeitungswerkzeuge:',
  'Execution tools:': 'Ausfhrungswerkzeuge:',
  'Step {{n}}: Choose Background Color':
    'Schritt {{n}}: Hintergrundfarbe whlen',
  'Step {{n}}: Confirm and Save': 'Schritt {{n}}: Besttigen und Speichern',
  // Agents - Navigation & Instructions
  'Esc to cancel': 'Esc zum Abbrechen',
  'Press Enter to save, e to save and edit, Esc to go back':
    'Enter zum Speichern, e zum Speichern und Bearbeiten, Esc zum Zurckgehen',
  ...
  'Enter a clear, unique name for this subagent.':
    'Geben Sie einen eindeutigen Namen fr diesen Unteragenten ein.',
  'e.g., Code Reviewer': 'z.B. Code-Reviewer',
  'Name cannot be empty.': 'Name darf nicht leer sein.',
  "Write the system prompt that defines this subagent's behavior. Be comprehensive for best results.":
    'Schreiben Sie den System-Prompt, der das Verhalten dieses Unteragenten definiert. Ausfhrlich fr beste Ergebnisse.',
  'e.g., You are an expert code reviewer...':
    'z.B. Sie sind ein Experte fr Code-Reviews...',
  ...
  'e.g., Reviews code for best practices and potential bugs.':
    'z.B. berprft Code auf Best Practices und mgliche Fehler.',
  ...
  'To see changes, Qwen Code must be restarted. Press r to exit and apply changes now.':
    'Um nderungen zu sehen, muss Qwen Code neu gestartet werden. Drcken Sie r, um jetzt zu beenden und nderungen anzuwenden.',
  // ============================================================================
  // Settings Labels
  // ============================================================================
  'Vim Mode': 'Vim-Modus',
  ...
  'Language: UI': 'Sprache: Benutzeroberflche',
  ...
  'Custom Witty Phrases': 'Benutzerdefinierte Witzige Sprche',
  'Show Welcome Back Dialog': 'Willkommen-zurck-Dialog anzeigen',
  ...
  'Skip Next Speaker Check': 'Nchste-Sprecher-Prfung berspringen',
  ...
  'Tool Output Truncation Threshold':
    'Schwellenwert fr Werkzeugausgabe-Krzung',
  'Tool Output Truncation Lines': 'Zeilen fr Werkzeugausgabe-Krzung',
  'Folder Trust': 'Ordnervertrauen',
  'Tool Schema Compliance': 'Tool Schema-Konformitt',
  ...
  'check session stats. Usage: /stats [model|tools]':
    'Sitzungsstatistiken prfen. Verwendung: /stats [model|tools]',
  ...
  'Add directories to the workspace. Use comma to separate multiple paths':
    'Verzeichnisse zum Arbeitsbereich hinzufgen. Komma zum Trennen mehrerer Pfade verwenden',
  'Show all directories in the workspace':
    'Alle Verzeichnisse im Arbeitsbereich anzeigen',
  'set external editor preference': 'Externen Editor festlegen',
  'Select Editor': 'Editor auswhlen',
  'Editor Preference': 'Editor-Einstellung',
  'These editors are currently supported. Please note that some editors cannot be used in sandbox mode.':
    'Diese Editoren werden derzeit untersttzt. Bitte beachten Sie, dass einige Editoren nicht im Sandbox-Modus verwendet werden knnen.',
  ...
  'Do you want to continue? [Y/n]: ': 'Mchten Sie fortfahren? [Y/n]: ',
  'Do you want to continue?': 'Mchten Sie fortfahren?',
  'Installing extension "{{name}}".':
    'Erweiterung "{{name}}" wird installiert.',
  '**Extensions may introduce unexpected behavior. Ensure you have investigated the extension source and trust the author.**':
    '**Erweiterungen knnen unerwartetes Verhalten verursachen. Stellen Sie sicher, dass Sie die Erweiterungsquelle untersucht haben und dem Autor vertrauen.**',
  'This extension will run the following MCP servers:':
    'Diese Erweiterung wird folgende MCP servers ausfhren:',
  local: 'lokal',
  'This extension will add the following commands: {{commands}}.':
    'Diese Erweiterung wird folgende Befehle hinzufgen: {{commands}}.',
  'This extension will append info to your QWEN.md context using {{fileName}}':
    'Diese Erweiterung wird Informationen zu Ihrem QWEN.md-Kontext mit {{fileName}} hinzufgen',
  'This extension will install the following skills:':
    'Diese Erweiterung wird folgende Fhigkeiten installieren:',
  ...
  'You are installing an extension from {{originSource}}. Some features may not work perfectly with Qwen Code.':
    'Sie installieren eine Erweiterung von {{originSource}}. Einige Funktionen funktionieren mglicherweise nicht perfekt mit Qwen Code.',
  '--ref and --auto-update are not applicable for marketplace extensions.':
    '--ref und --auto-update sind nicht anwendbar fr Marketplace-Erweiterungen.',
  ...
  'The git ref to install from.': 'Die Git-Referenz fr die Installation.',
  'Enable auto-update for this extension.':
    'Automatisches Update fr diese Erweiterung aktivieren.',
  'Enable pre-release versions for this extension.':
    'Pre-Release-Versionen fr diese Erweiterung aktivieren.',
  'Acknowledge the security risks of installing an extension and skip the confirmation prompt.':
    'Sicherheitsrisiken der Erweiterungsinstallation besttigen und Besttigungsaufforderung berspringen.',
  ...
  'Extension "{{name}}" successfully enabled for scope "{{scope}}".':
    'Erweiterung "{{name}}" erfolgreich fr Bereich "{{scope}}" aktiviert.',
  'Extension "{{name}}" successfully enabled in all scopes.':
    'Erweiterung "{{name}}" erfolgreich in allen Bereichen aktiviert.',
  'Invalid scope: {{scope}}. Please use one of {{scopes}}.':
    'Ungltiger Bereich: {{scope}}. Bitte verwenden Sie einen von {{scopes}}.',
  ...
  'Extension "{{name}}" successfully disabled for scope "{{scope}}".':
    'Erweiterung "{{name}}" erfolgreich fr Bereich "{{scope}}" deaktiviert.',
  ...
  'Link extension failed to install.':
    'Verknpfte Erweiterung konnte nicht installiert werden.',
  'Extension "{{name}}" linked successfully and enabled.':
    'Erweiterung "{{name}}" erfolgreich verknpft und aktiviert.',
  'Links an extension from a local path. Updates made to the local path will always be reflected.':
    'Verknpft eine Erweiterung von einem lokalen Pfad. nderungen am lokalen Pfad werden immer widergespiegelt.',
  'The name of the extension to link.':
    'Der Name der zu verknpfenden Erweiterung.',
  'Set a specific setting for an extension.':
    'Legt eine bestimmte Einstellung fr eine Erweiterung fest.',
  ...
  'Settings for "{{name}}":': 'Einstellungen fr "{{name}}":',
  '(workspace)': '(Arbeitsbereich)',
  '(user)': '(Benutzer)',
  '[not set]': '[nicht gesetzt]',
  '[value stored in keychain]': '[Wert in Schlsselbund gespeichert]',
  'Manage extension settings.': 'Erweiterungseinstellungen verwalten.',
  'You need to specify a command (set or list).':
    'Sie mssen einen Befehl angeben (set oder list).',
  // ============================================================================
  // Plugin Choice / Marketplace
  // ============================================================================
  'No plugins available in this marketplace.':
    'In diesem Marktplatz sind keine Plugins verfgbar.',
  'Select a plugin to install from marketplace "{{name}}":':
    'Whlen Sie ein Plugin zur Installation aus Marktplatz "{{name}}":',
  'Plugin selection cancelled.': 'Plugin-Auswahl abgebrochen.',
  'Select a plugin from "{{name}}"': 'Plugin aus "{{name}}" auswhlen',
  'Use  or j/k to navigate, Enter to select, Escape to cancel':
    'Verwenden Sie  oder j/k zum Navigieren, Enter zum Auswhlen, Escape zum Abbrechen',
  '{{count}} more above': '{{count}} weitere oben',
  '{{count}} more below': '{{count}} weitere unten',
  'manage IDE integration': 'IDE-Integration verwalten',
  'check status of IDE integration': 'Status der IDE-Integration prfen',
  'install required IDE companion for {{ideName}}':
    'Erforderlichen IDE-Begleiter fr {{ideName}} installieren',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run Qwen Code in one of these supported IDEs: VS Code or VS Code forks.':
    'IDE-Integration wird in Ihrer aktuellen Umgebung nicht untersttzt. Um diese Funktion zu nutzen, fhren Sie Qwen Code in einer dieser untersttzten IDEs aus: VS Code oder VS Code-Forks.',
  'Set up GitHub Actions': 'GitHub Actions einrichten',
  'Configure terminal keybindings for multiline input (VS Code, Cursor, Windsurf, Trae)':
    'Terminal-Tastenbelegungen fr mehrzeilige Eingabe konfigurieren (VS Code, Cursor, Windsurf, Trae)',
  ...
  '{{terminalName}} keybindings.json exists but is not a valid JSON array. Please fix the file manually or delete it to allow automatic configuration.':
    '{{terminalName}} keybindings.json existiert, ist aber kein gltiges JSON-Array. Bitte korrigieren Sie die Datei manuell oder lschen Sie sie, um automatische Konfiguration zu ermglichen.',
  'File: {{file}}': 'Datei: {{file}}',
  'Failed to parse {{terminalName}} keybindings.json. The file contains invalid JSON. Please fix the file manually or delete it to allow automatic configuration.':
    'Fehler beim Parsen von {{terminalName}} keybindings.json. Die Datei enthlt ungltiges JSON. Bitte korrigieren Sie die Datei manuell oder lschen Sie sie, um automatische Konfiguration zu ermglichen.',
  ...
  'Please check and modify manually if needed: {{file}}':
    'Bitte prfen und bei Bedarf manuell ndern: {{file}}',
  'Added Shift+Enter and Ctrl+Enter keybindings to {{terminalName}}.':
    'Shift+Enter und Ctrl+Enter Tastenbelegungen zu {{terminalName}} hinzugefgt.',
  'Modified: {{file}}': 'Gendert: {{file}}',
  ...
  'Your terminal is already configured for an optimal experience with multiline input (Shift+Enter and Ctrl+Enter).':
    'Ihr Terminal ist bereits fr optimale Erfahrung mit mehrzeiliger Eingabe konfiguriert (Shift+Enter und Ctrl+Enter).',
  // ============================================================================
  // Commands - Hooks
  // ============================================================================
  ...
  'Press Escape to close': 'Escape zum Schlieen drcken',
  'Press Escape, Ctrl+C, or Ctrl+D to cancel':
    'Escape, Ctrl+C oder Ctrl+D zum Abbrechen',
  'Press Space, Enter, or Escape to dismiss':
    'Space, Enter oder Escape zum Schlieen',
  'No hook selected': 'Kein Hook ausgewhlt',
  // Hooks - List Step
  ...
  'This menu is read-only. To add or modify hooks, edit settings.json directly or ask Qwen Code.':
    'Dieses Men ist schreibgeschtzt. Um Hooks hinzuzufgen oder zu ndern, bearbeiten Sie settings.json direkt oder fragen Sie Qwen Code.',
  'Enter to select  Esc to cancel': 'Enter zum Auswhlen  Esc zum Abbrechen',
  // Hooks - Detail Step
  'Exit codes:': 'Exit-Codes:',
  'Configured hooks:': 'Konfigurierte Hooks:',
  'No hooks configured for this event.':
    'Fr dieses Ereignis sind keine Hooks konfiguriert.',
  'To add hooks, edit settings.json directly or ask Qwen.':
    'Um Hooks hinzuzufgen, bearbeiten Sie settings.json direkt oder fragen Sie Qwen.',
  'Enter to select  Esc to go back': 'Enter zum Auswhlen  Esc zum Zurck',
  // Hooks - Config Detail Step
  'Hook details': 'Hook-Details',
  'Event:': 'Ereignis:',
  'Extension:': 'Erweiterung:',
  'Desc:': 'Beschreibung:',
  'No hook config selected': 'Keine Hook-Konfiguration ausgewhlt',
  'To modify or remove this hook, edit settings.json directly or ask Qwen to help.':
    'Um diesen Hook zu ndern oder zu entfernen, bearbeiten Sie settings.json direkt oder fragen Sie Qwen.',
  // Hooks - Disabled Step
  'Hook Configuration - Disabled': 'Hook-Konfiguration - Deaktiviert',
  'All hooks are currently disabled. You have {{count}} that are not running.':
    'Alle Hooks sind derzeit deaktiviert. Sie haben {{count}} die nicht ausgefhrt werden.',
  ...
  'No hook commands will execute': 'Keine Hook-Befehle werden ausgefhrt',
  ...
  'Session (temporary)': 'Sitzung (temporr)',
  // Hooks - Event Descriptions (short)
  'Before tool execution': 'Vor der Tool-Ausfhrung',
  'After tool execution': 'Nach der Tool-Ausfhrung',
  'After tool execution fails': 'Wenn die Tool-Ausfhrung fehlschlgt',
  ...
  'Right before Qwen Code concludes its response':
    'Direkt bevor Qwen Code seine Antwort abschliet',
  'When a subagent (Agent tool call) is started':
    'Wenn ein Subagent (Agent-Tool-Aufruf) gestartet wird',
  'Right before a subagent concludes its response':
    'Direkt bevor ein Subagent seine Antwort abschliet',
  'Before conversation compaction': 'Vor der Gesprchskomprimierung',
  ...
  'Input to command is JSON with original user prompt text.':
    'Die Eingabe an den Befehl ist JSON mit dem ursprnglichen Benutzer-Prompt-Text.',
  ...
  'Input to command is JSON with tool_name, tool_input, and tool_use_id. Output JSON with hookSpecificOutput containing decision to allow or deny.':
    'Die Eingabe an den Befehl ist JSON mit tool_name, tool_input und tool_use_id. Ausgabe ist JSON mit hookSpecificOutput, das die Entscheidung zum Zulassen oder Ablehnen enthlt.',
  ...
  'block processing, erase original prompt, and show stderr to user only':
    'Verarbeitung blockieren, ursprnglichen Prompt lschen und stderr nur dem Benutzer anzeigen',
  ...
  'stdout appended as custom compact instructions':
    'stdout als benutzerdefinierte Komprimierungsanweisungen angehngt',
  ...
  'Cannot branch while a response or tool call is in progress. Wait for it to finish or resolve the pending tool call.':
    'Whrend eine Antwort oder ein Tool-Aufruf luft, kann keine Verzweigung erstellt werden. Warten Sie, bis der Vorgang abgeschlossen ist, oder bearbeiten Sie den ausstehenden Tool-Aufruf.',
  'No conversation to branch.': 'Keine Unterhaltung zum Verzweigen vorhanden.',
  'Restore a tool call. This will reset the conversation and file history to the state it was in when the tool call was suggested':
    'Einen Tool-Aufruf wiederherstellen. Dadurch werden Konversations- und Dateiverlauf auf den Zustand zurckgesetzt, in dem der Tool-Aufruf vorgeschlagen wurde',
  'Could not detect terminal type. Supported terminals: VS Code, Cursor, Windsurf, and Trae.':
    'Terminal-Typ konnte nicht erkannt werden. Untersttzte Terminals: VS Code, Cursor, Windsurf und Trae.',
  'Terminal "{{terminal}}" is not supported yet.':
    'Terminal "{{terminal}}" wird noch nicht untersttzt.',

  // ============================================================================
  // Commands - Language
  // ============================================================================
  'Invalid language. Available: {{options}}':
    'Ungltige Sprache. Verfgbar: {{options}}',
  'Language subcommands do not accept additional arguments.':
    'Sprach-Unterbefehle akzeptieren keine zustzlichen Argumente.',
  ...
  'UI language changed to {{lang}}': 'UI-Sprache gendert zu {{lang}}',
  ...
  'Invalid command. Available subcommands:':
    'Ungltiger Befehl. Verfgbare Unterbefehle:',
  'Available subcommands:': 'Verfgbare Unterbefehle:',
  'To request additional UI language packs, please open an issue on GitHub.':
    'Um zustzliche UI-Sprachpakete anzufordern, ffnen Sie bitte ein Issue auf GitHub.',
  'Available options:': 'Verfgbare Optionen:',
  ...
  'Analyze only, do not modify files or execute commands':
    'Nur analysieren, keine Dateien ndern oder Befehle ausfhren',
  'Require approval for file edits or shell commands':
    'Genehmigung fr Dateibearbeitungen oder Shell-Befehle erforderlich',
  ...
  'Auto-dream: {{status}}  {{lastDream}}  /dream to run':
    'Auto-Konsolidierung: {{status}}  {{lastDream}}  /dream zum Ausfhren',
  never: 'nie',
  on: 'ein',
  off: 'aus',
  'Remove matching entries from managed auto-memory.':
    'Passende Eintrge aus dem verwalteten Auto-Speicher entfernen.',
  'Usage: /forget <memory text to remove>':
    'Verwendung: /forget <zu entfernender Erinnerungstext>',
  'No managed auto-memory entries matched: {{query}}':
    'Keine verwalteten Auto-Speicher-Eintrge gefunden: {{query}}',
  ...
  "Successfully authenticated and refreshed tools for '{{name}}'.":
    "Erfolgreich authentifiziert und Werkzeuge fr '{{name}}' aktualisiert.",
  "Re-discovering tools from '{{name}}'...":
    "Werkzeuge von '{{name}}' werden neu erkannt...",
  "Discovered {{count}} tool(s) from '{{name}}'.":
    "{{count}} Werkzeug(e) von '{{name}}' entdeckt.",
  'Authentication complete. Returning to server details...':
    'Authentifizierung abgeschlossen. Zurck zu den Serverdetails...',
  ...
  'Switch the model for this session (--fast for suggestion model, [model-id] to switch immediately).':
    'Modell fr diese Sitzung wechseln (--fast fr Vorschlagsmodell)',
  'Set a lighter model for prompt suggestions and speculative execution':
    'Leichteres Modell fr Eingabevorschlge und spekulative Ausfhrung festlegen',
  'Content generator configuration not available.':
    'Inhaltsgenerator-Konfiguration nicht verfgbar.',
  'Authentication type not available.':
    'Authentifizierungstyp nicht verfgbar.',
  'No models available for the current authentication type ({{authType}}).':
    'Keine Modelle fr den aktuellen Authentifizierungstyp ({{authType}}) verfgbar.',
  // Needs translation
  ...
  'Starting a new session, resetting chat, and clearing terminal.':
    'Neue Sitzung wird gestartet, Chat wird zurckgesetzt und Terminal wird gelscht.',
  'Starting a new session and clearing.':
    'Neue Sitzung wird gestartet und gelscht.',

  // ============================================================================
  // Commands - Compress
  // ============================================================================
  'Already compressing, wait for previous request to complete':
    'Komprimierung luft bereits, warten Sie auf Abschluss der vorherigen Anfrage',
  ...
  'Compression was not beneficial for this history size.':
    'Komprimierung war fr diese Verlaufsgre nicht vorteilhaft.',
  'Chat history compression did not reduce size. This may indicate issues with the compression prompt.':
    'Chatverlauf-Komprimierung hat die Gre nicht reduziert. Dies kann auf Probleme mit dem Komprimierungs-Prompt hindeuten.',
  'Could not compress chat history due to a token counting error.':
    'Chatverlauf konnte aufgrund eines Token-Zhlfehlers nicht komprimiert werden.',
  // ============================================================================
  // Commands - Directory
  // ============================================================================
  'Configuration is not available.': 'Konfiguration ist nicht verfgbar.',
  'Please provide at least one path to add.':
    'Bitte geben Sie mindestens einen Pfad zum Hinzufgen an.',
  'The /directory add command is not supported in restrictive sandbox profiles. Please use --include-directories when starting the session instead.':
    'Der Befehl /directory add wird in restriktiven Sandbox-Profilen nicht untersttzt. Bitte verwenden Sie --include-directories beim Starten der Sitzung.',
  "Error adding '{{path}}': {{error}}":
    "Fehler beim Hinzufgen von '{{path}}': {{error}}",
  'Successfully added QWEN.md files from the following directories if there are:\n- {{directories}}':
    'QWEN.md-Dateien aus folgenden Verzeichnissen erfolgreich hinzugefgt, falls vorhanden:\n- {{directories}}',
  'Error refreshing memory: {{error}}':
    'Fehler beim Aktualisieren des Speichers: {{error}}',
  'Successfully added directories:\n- {{directories}}':
    'Verzeichnisse erfolgreich hinzugefgt:\n- {{directories}}',
  ...
  'Opening documentation in your browser: {{url}}':
    'Dokumentation wird in Ihrem Browser geffnet: {{url}}',

  // ============================================================================
  // Dialogs - Tool Confirmation
  // ============================================================================
  'Do you want to proceed?': 'Mchten Sie fortfahren?',
  ...
  'Loading...': 'Ldt...',
  'Unknown step': 'Unbekannter Schritt',
  'Esc to back': 'Esc zurck',
  ' to navigate  Enter to select  Esc to close':
    ' navigieren  Enter auswhlen  Esc schlieen',
  ' to navigate  Enter to select  Esc to back':
    ' navigieren  Enter auswhlen  Esc zurck',
  ' to navigate  Enter to confirm  Esc to back':
    ' navigieren  Enter besttigen  Esc zurck',
  ...
  'Select where to add the server to the exclude list:':
    'Whlen Sie, wo der Server zur Ausschlussliste hinzugefgt werden soll:',
  'Press Enter to confirm, Esc to cancel':
    'Enter zum Besttigen, Esc zum Abbrechen',
  Disable: 'Deaktivieren',
  Enable: 'Aktivieren',
  Authenticate: 'Authentifizieren',
  'Re-authenticate': 'Erneut authentifizieren',
  'Clear Authentication': 'Authentifizierung lschen',
  ...
  'No server selected': 'Kein Server ausgewhlt',
  'Error:': 'Fehler:',
  tool: 'Werkzeug',
  tools: 'Werkzeuge',
  connected: 'verbunden',
  ...
  'Add MCP servers to your settings to get started.':
    'Fgen Sie MCP servers zu Ihren Einstellungen hinzu, um zu beginnen.',
  'Run qwen --debug to see error logs':
    'Fhren Sie qwen --debug aus, um Fehlerprotokolle anzuzeigen',

  // MCP OAuth Authentication
  'OAuth Authentication': 'OAuth-Authentifizierung',
  'Authenticating... Please complete the login in your browser.':
    'Authentifizierung luft... Bitte schlieen Sie die Anmeldung in Ihrem Browser ab.',
  // MCP Tool List
  'No tools available for this server.':
    'Keine Werkzeuge fr diesen Server verfgbar.',
  destructive: 'destruktiv',
  'read-only': 'schreibgeschtzt',
  'open-world': 'offene Welt',
  idempotent: 'idempotent',
  'Tools for {{serverName}}': 'Werkzeuge fr {{serverName}}',
  '{{current}}/{{total}}': '{{current}}/{{total}}',

  // MCP Tool Detail
  required: 'erforderlich',
  Parameters: 'Parameter',
  'No tool selected': 'Kein Werkzeug ausgewhlt',
  Server: 'Server',

  // Invalid tool related translations
  '{{count}} invalid tools': '{{count}} ungltige Werkzeuge',
  invalid: 'ungltig',
  'invalid: {{reason}}': 'ungltig: {{reason}}',
  ...
  'Tools must have both name and description to be used by the LLM.':
    'Werkzeuge mssen sowohl einen Namen als auch eine Beschreibung haben, um vom LLM verwendet zu werden.',
  'Modify in progress:': 'nderung in Bearbeitung:',
  'Save and close external editor to continue':
    'Speichern und externen Editor schlieen, um fortzufahren',
  ...
  "Allow execution of: '{{command}}'?":
    "Ausfhrung erlauben von: '{{command}}'?",
  'Always allow in this project': 'In diesem Projekt immer erlauben',
  'Always allow {{action}} in this project':
    '{{action}} in diesem Projekt immer erlauben',
  'Always allow for this user': 'Fr diesen Benutzer immer erlauben',
  'Always allow {{action}} for this user':
    '{{action}} fr diesen Benutzer immer erlauben',
  ...
  'Allow execution of MCP tool "{{tool}}" from server "{{server}}"?':
    'Ausfhrung von MCP tool "{{tool}}" von MCP server "{{server}}" erlauben?',
  // ============================================================================
  // Dialogs - Shell Confirmation
  // ============================================================================
  'Shell Command Execution': 'Shell-Befehlsausfhrung',
  'A custom command wants to run the following shell commands:':
    'Ein benutzerdefinierter Befehl mchte folgende Shell-Befehle ausfhren:',
  // ============================================================================
  ...
  'What would you like to do?': 'Was mchten Sie tun?',
  'Choose how to proceed with your session:':
    'Whlen Sie, wie Sie mit Ihrer Sitzung fortfahren mchten:',
  'Start new chat session': 'Neue Chat-Sitzung starten',
  'Continue previous conversation': 'Vorheriges Gesprch fortsetzen',
  ' Welcome back! (Last updated: {{timeAgo}})':
    ' Willkommen zurck! (Zuletzt aktualisiert: {{timeAgo}})',
  ' Overall Goal:': ' Gesamtziel:',
  'Connect a Provider': 'Anbieter verbinden',
  'You must connect a provider to proceed. Press Ctrl+C again to exit.':
    'Sie mssen einen Anbieter verbinden, um fortzufahren. Drcken Sie erneut Ctrl+C zum Beenden.',
  ...
  'Qwen OAuth free tier was discontinued on 2026-04-15. Please select Coding Plan or API Key instead.':
    'Das kostenlose Qwen OAuth-Kontingent wurde am 2026-04-15 eingestellt. Bitte whlen Sie Coding Plan oder API Key.',
  'Qwen OAuth free tier was discontinued on 2026-04-15. Please select a model from another provider or run /auth to switch.':
    'Das kostenlose Qwen OAuth-Angebot wurde am 2026-04-15 eingestellt. Bitte whlen Sie ein Modell eines anderen Anbieter oder fhren Sie /auth aus, um zu wechseln.',
  '\n Qwen OAuth free tier was discontinued on 2026-04-15. Please select another option.\n':
    '\n Das kostenlose Qwen OAuth-Kontingent wurde am 2026-04-15 eingestellt. Bitte whlen Sie eine andere Option.\n',
  ...
  'OAuth token expired (over {{seconds}} seconds). Please select authentication method again.':
    'OAuth-Token abgelaufen (ber {{seconds}} Sekunden). Bitte whlen Sie erneut eine Authentifizierungsmethode.',
  'Press any key to return to authentication type selection.':
    'Drcken Sie eine beliebige Taste, um zur Authentifizierungstypauswahl zurckzukehren.',
  ...
  'Waiting for auth... (Press ESC or CTRL+C to cancel)':
    'Warten auf Authentifizierung... (ESC oder CTRL+C zum Abbrechen drcken)',
  'Missing API key for OpenAI-compatible auth. Set settings.security.auth.apiKey, or set the {{envKeyHint}} environment variable.':
    'API Key fr OpenAI-kompatible Authentifizierung fehlt. Setzen Sie settings.security.auth.apiKey oder die Umgebungsvariable {{envKeyHint}}.',
  ...
  'Missing API key for OpenAI-compatible auth. Set the {{envKeyHint}} environment variable.':
    'API Key fr OpenAI-kompatible Authentifizierung fehlt. Setzen Sie die Umgebungsvariable {{envKeyHint}}.',
  ...
  'Invalid auth method selected.':
    'Ungltige Authentifizierungsmethode ausgewhlt.',
  ...
  'Invalid QWEN_DEFAULT_AUTH_TYPE value: "{{value}}". Valid values are: {{validValues}}':
    'Ungltiger QWEN_DEFAULT_AUTH_TYPE-Wert: "{{value}}". Gltige Werte sind: {{validValues}}',
  // ============================================================================
  // Dialogs - Model
  // ============================================================================
  'Select Model': 'Modell auswhlen',
  'API Key': 'API Key',
  '(default)': '(Standard)',
  '(not set)': '(nicht gesetzt)',
  Modality: 'Modalitt',
  ...
  'Manage trusted directories for this workspace.':
    'Vertrauenswrdige Verzeichnisse fr diesen Arbeitsbereich verwalten.',
  ...
  'Add a new rule...': 'Neue Regel hinzufgen...',
  'Add {{type}} permission rule': '{{type}} permission rule hinzufgen',
  ...
  'Enter to confirm  Esc to cancel':
    'Enter zum Besttigen  Esc zum Abbrechen',
  'Delete {{type}} rule?': '{{type}}-Regel lschen?',
  'Are you sure you want to delete this permission rule?':
    'Sind Sie sicher, dass Sie diese permission rule lschen mchten?',
  'Permissions:': 'Berechtigungen:',
  '(<-/-> or tab to cycle)': '(<-/-> oder Tab zum Wechseln)',
  'Press  to navigate  Enter to select  Type to search  Esc to cancel':
    ' navigieren  Enter auswhlen  Tippen suchen  Esc abbrechen',
  'Search...': 'Suche...',
  // Workspace directory management
  'Add directory...': 'Verzeichnis hinzufgen...',
  'Add directory to workspace': 'Verzeichnis zum Arbeitsbereich hinzufgen',
  ...
  'Tab to complete  Enter to add  Esc to cancel':
    'Tab zum Vervollstndigen  Enter zum Hinzufgen  Esc zum Abbrechen',
  'Remove directory?': 'Verzeichnis entfernen?',
  'Are you sure you want to remove this directory from the workspace?':
    'Mchten Sie dieses Verzeichnis wirklich aus dem Arbeitsbereich entfernen?',
  '  (Original working directory)': '  (Ursprngliches Arbeitsverzeichnis)',
  ...
  // ============================================================================
  'Using:': 'Verwendet:',
  '{{count}} open file': '{{count}} geffnete Datei',
  '{{count}} open files': '{{count}} geffnete Dateien',
  ...
  'Press Ctrl+C again to exit.': 'Drcken Sie erneut Ctrl+C zum Beenden.',
  'Press Ctrl+D again to exit.': 'Drcken Sie erneut Ctrl+D zum Beenden.',
  'Press Esc again to clear.': 'Drcken Sie erneut Esc zum Lschen.',
  'Press  to edit queued messages':
    'Drcken Sie , um Nachrichten in der Warteschlange zu bearbeiten',
  ...
  'Note: First startup may take longer. Tool availability will update automatically.':
    'Hinweis: Der erste Start kann lnger dauern. Werkzeugverfgbarkeit wird automatisch aktualisiert.',
  'Configured MCP servers:': 'Konfigurierte MCP servers:',
  Ready: 'Bereit',
  'Starting... (first startup may take longer)':
    'Wird gestartet... (erster Start kann lnger dauern)',
  Disconnected: 'Getrennt',
  ...
  'to authenticate with OAuth-enabled servers':
    'um sich bei OAuth-fhigen Servern zu authentifizieren',
  Press: 'Drcken Sie',
  'to toggle tool descriptions on/off':
    'um Werkzeugbeschreibungen ein-/auszuschalten',
  "Starting OAuth authentication for MCP server '{{name}}'...":
    "OAuth-Authentifizierung fr MCP server '{{name}}' wird gestartet...",
  // ============================================================================
  // Startup Tips
  // ============================================================================
  ...
  'To continue this session, run':
    'Um diese Sitzung fortzusetzen, fhren Sie aus',
  ...
  'Tip: For a full token breakdown, run `/stats model`.':
    'Tipp: Fr eine vollstndige Token-Aufschlsselung fhren Sie `/stats model` aus.',
  'Model Stats For Nerds': 'Modellstatistiken fr Nerds',
  'Tool Stats For Nerds': 'Werkzeugstatistiken fr Nerds',
  Metric: 'Metrik',
  API: 'API',
  Requests: 'Anfragen',
  Errors: 'Fehler',
  ...
  'Total Reviewed Suggestions:': 'Insgesamt berprfter Vorschlge:',
  '  Accepted:': '  Akzeptiert:',
  '  Rejected:': '  Abgelehnt:',
  '  Modified:': '  Gendert:',
  ...
  'Session start time is unavailable, cannot calculate stats.':
    'Sitzungsstartzeit nicht verfgbar, Statistiken knnen nicht berechnet werden.',
  ...
  'The TOML format is deprecated. Would you like to migrate them to Markdown format?':
    'Das TOML-Format ist veraltet. Mchten Sie sie ins Markdown-Format migrieren?',
  ...
  // Loading Phrases
  // ============================================================================
  'Waiting for user confirmation...': 'Warten auf Benutzerbesttigung...',
  // ============================================================================
  // Loading Phrases
  // ============================================================================
  WITTY_LOADING_PHRASES: [
    'Auf gut Glck!',
    'Genialitt wird ausgeliefert...',
    ...
    'Die KI-Hamster werden aufgewrmt...',
    ...
    'Frische Bytes werden gebrht...',
    'Elektronen werden gezhlt...',
    'Kognitive Prozessoren werden aktiviert...',
    'Auf Syntaxfehler im Universum wird geprft...',
    ...
    'Einen Moment, ich debugge die Realitt...',
    'Die Optionen werden verwirrt...',
    'Kosmische Frequenzen werden eingestellt...',
    'Eine Antwort wird erstellt, die Ihrer Geduld wrdig ist...',
    'Die Einsen und Nullen werden kompiliert...',
    'Abhngigkeiten werden aufgelst... und existenzielle Krisen...',
    'Erinnerungen werden defragmentiert... sowohl RAM als auch persnliche...',
    'Das Humor-Modul wird neu gestartet...',
    'Das Wesentliche wird zwischengespeichert (hauptschlich Katzen-Memes)...',
    'Fr lcherliche Geschwindigkeit wird optimiert',
    'Bits werden getauscht... sagen Sie es nicht den Bytes...',
    'Garbage Collection luft... bin gleich zurck...',
    'Das Internet wird zusammengebaut...',
    'Kaffee wird in Code umgewandelt...',
    'Die Syntax der Realitt wird aktualisiert...',
    'Die Synapsen werden neu verdrahtet...',
    'Ein verlegtes Semikolon wird gesucht...',
    'Die Zahnrder werden geschmiert...',
    ...
    'Die Sterne werden fr optimale Antwort ausgerichtet...',
    'So sagen wir alle...',
    'Die nchste groe Idee wird geladen...',
    ...
    'Keine Panik...',
    'Dem weien Kaninchen wird gefolgt...',
    ...
    'Der Kuchen ist keine Lge, er ldt nur noch...',
    'Am Charaktererstellungsbildschirm wird herumgefummelt...',
    'Einen Moment, ich suche das richtige Meme...',
    "'A' wird zum Fortfahren gedrckt...",
    'Digitale Katzen werden gehtet...',
    ...
    'Unsere Hamster arbeiten so schnell sie knnen...',
    ...
    'Ich habe ein gutes Gefhl dabei...',
    'Den Bren wird gestupst...',
    ...
    'Warum mgen Programmierer keine Natur? Sie hat zu viele Bugs...',
    ...
    'Gerade erinnert, wo ich meine Schlssel hingelegt habe...',
    'ber die Kugel wird nachgedacht...',
    'Ich habe Dinge gesehen, die Sie nicht glauben wrden... wie einen Benutzer, der Lademeldungen liest.',
    ...
    'Quantenteilchen werden fr schnellere Antwort verschrnkt...',
    'Das Chrom wird poliert... an den Algorithmen.',
    'Sind Sie nicht unterhalten? (Arbeite daran!)',
    'Die Code-Gremlins werden beschworen... zum Helfen, natrlich.',
    'Warte nur auf das Einwahlton-Ende...',
    'Das Humor-O-Meter wird neu kalibriert.',
    'Mein anderer Ladebildschirm ist noch lustiger.',
    'Ziemlich sicher, dass irgendwo eine Katze ber die Tastatur luft...',
    'Verbessern... Verbessern... Ldt noch.',
    ...
    'Zustzliche Pylonen werden gebaut...',
  ],
  ...
  'Press Enter to submit, Escape to cancel':
    'Enter zum Absenden, Escape zum Abbrechen drcken',
  ...
  'The TOML format for commands is being deprecated in favor of Markdown format.':
    'Das TOML-Format fr Befehle wird zugunsten des Markdown-Formats eingestellt.',
  'Markdown format is more readable and easier to edit.':
    'Das Markdown-Format ist lesbarer und einfacher zu bearbeiten.',
  'You can migrate these files automatically using:':
    'Sie knnen diese Dateien automatisch migrieren mit:',
  ...
  'Would open extensions page in your browser: {{url}} (skipped in test environment)':
    'Wrde Erweiterungsseite im Browser ffnen: {{url}} (bersprungen in Testumgebung)',
  'View available extensions at {{url}}':
    'Verfgbare Erweiterungen ansehen unter {{url}}',
  'Opening extensions page in your browser: {{url}}':
    'Erweiterungsseite wird im Browser geffnet: {{url}}',
  'Failed to open browser. Check out the extensions gallery at {{url}}':
    'Browser konnte nicht geffnet werden. Besuchen Sie die Erweiterungsgalerie unter {{url}}',
  ...
  'Start a fresh idea with /clear or /new; the previous session stays available in history.':
    'Starten Sie eine neue Idee mit /clear oder /new; die vorherige Sitzung bleibt im Verlauf verfgbar.',
  ...
  'You can run any shell commands from Qwen Code using ! (e.g. !ls).':
    'Sie knnen beliebige Shell-Befehle in Qwen Code mit ! ausfhren (z. B. !ls).',
  'Type / to open the command popup; Tab autocompletes slash commands and saved prompts.':
    'Geben Sie / ein, um das Befehlsmen zu ffnen; Tab vervollstndigt Slash-Befehle und gespeicherte Prompts.',
  'You can resume a previous conversation by running qwen --continue or qwen --resume.':
    'Sie knnen eine frhere Unterhaltung mit qwen --continue oder qwen --resume fortsetzen.',
  'You can switch permission mode quickly with Shift+Tab or /approval-mode.':
    'Sie knnen den Berechtigungsmodus schnell mit Shift+Tab oder /approval-mode wechseln.',
  'You can switch permission mode quickly with Tab or /approval-mode.':
    'Sie knnen den Berechtigungsmodus schnell mit Tab oder /approval-mode wechseln.',
  'Try /insight to generate personalized insights from your chat history.':
    'Probieren Sie /insight, um personalisierte Erkenntnisse aus Ihrem Chatverlauf zu erstellen.',
  'Press Ctrl+O to toggle compact mode -- hide tool output and thinking for a cleaner view.':
    'Ctrl+O drcken, um den Kompaktmodus umzuschalten -- Tool-Ausgabe und Denkprozess ausblenden.',
  'Add a QWEN.md file to give Qwen Code persistent project context.':
    'Fgen Sie eine QWEN.md-Datei hinzu, um Qwen Code dauerhaften Projektkontext zu geben.',
  'Use /btw to ask a quick side question without disrupting the conversation.':
    'Verwenden Sie /btw, um eine kurze Nebenfrage zu stellen, ohne die Unterhaltung zu unterbrechen.',
  'Context is almost full! Run /compress now or start /new to continue.':
    'Der Kontext ist fast voll! Fhren Sie jetzt /compress aus oder starten Sie /new, um fortzufahren.',
  'Context is getting full. Use /compress to free up space.':
    'Der Kontext fllt sich. Verwenden Sie /compress, um Platz freizugeben.',
  ...
  'You can configure your API key and models in settings.json':
    'Sie knnen Ihren API Key und Modelle in settings.json konfigurieren',
  ...
  'You can get your Coding Plan API key here':
    'Sie knnen Ihren Coding Plan API Key hier erhalten',
  ...
  'Select Region for Coding Plan': 'Region fr Coding Plan auswhlen',
  'Choose based on where your account is registered':
    'Whlen Sie basierend auf dem Registrierungsort Ihres Kontos',
  ...
  'New model configurations are available for {{region}}. Update now?':
    'Neue Modellkonfigurationen sind fr {{region}} verfgbar. Jetzt aktualisieren?',
  ...
  'No API response yet. Send a message to see actual usage.':
    'Noch keine API-Antwort. Senden Sie eine Nachricht, um die tatschliche Nutzung anzuzeigen.',
  'Estimated pre-conversation overhead':
    'Geschtzte Vorabkosten vor der Unterhaltung',
  'Context window': 'Kontextfenster',
  tokens: 'Tokens',
  Used: 'Verwendet',
  Free: 'Frei',
  ...
  'Run /context detail for per-item breakdown.':
    'Fhren Sie /context detail fr eine Aufschlsselung nach Elementen aus.',
  active: 'aktiv',
  ...
  'Tip: Use /model to switch between available Coding Plan models.':
    'Tipp: Verwenden Sie /model, um zwischen verfgbaren Coding Plan-Modellen zu wechseln.',
  ...
  '/: Navigate | <-/->: Switch tabs | Enter: Select':
    '/: Navigieren | <-/->: Tabs wechseln | Enter: Auswhlen',
  ...
  'Region for Coding Plan (china/global)':
    'Region fr Coding Plan (china/global)',
  'API key for Coding Plan': 'API Key fr Coding Plan',
  ...
  'Select authentication method:': 'Authentifizierungsmethode auswhlen:',
  '\n=== Authentication Status ===\n': '\n=== Authentifizierungsstatus ===\n',
  '  No authentication method configured.\n':
    '  Keine Authentifizierungsmethode konfiguriert.\n',
  'Run one of the following commands to get started:\n':
    'Fhren Sie einen der folgenden Befehle aus, um zu beginnen:\n',
  '  qwen auth qwen-oauth     - Authenticate with Qwen OAuth (discontinued)':
    '  qwen auth qwen-oauth     - Mit Qwen OAuth authentifizieren (eingestellt)',
  'Or simply run:': 'Oder einfach ausfhren:',
  ...
  '  Limit: No longer available': '  Limit: Nicht mehr verfgbar',
  'Qwen OAuth free tier was discontinued on 2026-04-15. Run /auth to switch to Coding Plan, OpenRouter, Fireworks AI, or another provider.':
    'Das kostenlose Qwen OAuth-Kontingent wurde am 2026-04-15 eingestellt. Fhren Sie /auth aus, um zu Coding Plan, OpenRouter, Fireworks AI oder einem anderen Anbieter zu wechseln.',
  ...
  '  Authentication Method: Alibaba Cloud Coding Plan (Incomplete)':
    '  Authentifizierungsmethode: Alibaba Cloud Coding Plan (Unvollstndig)',
  '  Issue: API key not found in environment or settings\n':
    '  Problem: API Key nicht in Umgebung oder Einstellungen gefunden\n',
  '  Run `qwen auth coding-plan` to re-configure.\n':
    '  Fhren Sie `qwen auth coding-plan` aus, um neu zu konfigurieren.\n',
  ' Authentication Method: {{type}}': ' Authentifizierungsmethode: {{type}}',
  '  Status: Configured\n': '  Status: Konfiguriert\n',
  'Failed to check authentication status: {{error}}':
    'Authentifizierungsstatus konnte nicht berprft werden: {{error}}',
  'Select an option:': 'Option auswhlen:',
  'Raw mode not available. Please run in an interactive terminal.':
    'Raw-Modus nicht verfgbar. Bitte in einem interaktiven Terminal ausfhren.',
  '(Use   arrows to navigate, Enter to select, Ctrl+C to exit)\n':
    '(  Pfeiltasten zum Navigieren, Enter zum Auswhlen, Ctrl+C zum Beenden)\n',
  'to toggle compact mode': 'Kompaktmodus umschalten',
  'Hide tool output and thinking for a cleaner view (toggle with Ctrl+O).':
    'Tool-Ausgabe und Denkprozess ausblenden fr eine bersichtlichere Ansicht (mit Ctrl+O umschalten).',
  'Press Ctrl+O to show full tool output':
    'Ctrl+O fr vollstndige Tool-Ausgabe drcken',
  ...
  'Enabled plan mode. The agent will analyze and plan without executing tools.':
    'Plan-Modus aktiviert. Der Agent analysiert und plant, ohne Werkzeuge auszufhren.',
  ...
  'Open the memory manager.': 'Den Speicher-Manager ffnen.',
  'Save a durable memory to the memory system.':
    'Eine dauerhafte Erinnerung im Speichersystem speichern.',
  'Open MCP management dialog': 'MCP-Verwaltungsdialog ffnen',
  'Manage extension settings': 'Erweiterungseinstellungen verwalten',
  ...
  'Open command menu': 'Befehlsmen ffnen',
  'Add file context': 'Dateikontext hinzufgen',
  'Accept suggestion / Autocomplete':
    'Vorschlag akzeptieren / automatisch vervollstndigen',
  'Reverse search history': 'Verlauf rckwrts durchsuchen',
  'Press ? again to close': 'Erneut ? drcken, um zu schlieen',
  '? for shortcuts': '? fr Tastenkrzel',
  'Invalid approval mode "{{arg}}". Valid modes: {{modes}}':
    'Ungltiger Freigabemodus "{{arg}}". Gltige Modi: {{modes}}',
  'Approval mode set to "{{mode}}"': 'Freigabemodus auf "{{mode}}" gesetzt',
  'Are you sure you want to uninstall extension "{{name}}"?':
    'Sind Sie sicher, dass Sie die Erweiterung "{{name}}" deinstallieren mchten?',
  ...
  'Disable "{{name}}" - Select Scope':
    '"{{name}}" deaktivieren - Bereich auswhlen',
  'Enable "{{name}}" - Select Scope':
    '"{{name}}" aktivieren - Bereich auswhlen',
  'No extension selected': 'Keine Erweiterung ausgewhlt',
  '{{count}} extensions installed': '{{count}} Erweiterungen installiert',
  'up to date': 'aktuell',
  'update available': 'Update verfgbar',
  'checking...': 'wird geprft...',
  ...
  'Select a model result and merge its diff into the current workspace':
    'Ein Modellergebnis auswhlen und dessen Diff in den aktuellen Arbeitsbereich bernehmen',
  ...
  'Arena session is still running. Wait for it to complete or use /arena stop first.':
    'Die Arena-Sitzung luft noch. Warten Sie, bis sie abgeschlossen ist, oder verwenden Sie zuerst /arena stop.',
  ...
  'Failed to apply changes from {{label}}: {{error}}':
    'Anwenden der nderungen von {{label}} fehlgeschlagen: {{error}}',
  'Applied changes from {{label}} to workspace. Arena session complete.':
    'nderungen von {{label}} auf den Arbeitsbereich angewendet. Arena-Sitzung abgeschlossen.',
  'Discard all Arena results and clean up worktrees?':
    'Alle Arena-Ergebnisse verwerfen und Arbeitsbume bereinigen?',
  'Arena results discarded. All worktrees cleaned up.':
    'Arena-Ergebnisse verworfen. Alle Arbeitsbume wurden bereinigt.',
  'Arena is not supported in non-interactive mode. Use interactive mode to start an Arena session.':
    'Arena wird im nicht-interaktiven Modus nicht untersttzt. Verwenden Sie den interaktiven Modus, um eine Arena-Sitzung zu starten.',
  'Arena is not supported in non-interactive mode. Use interactive mode to stop an Arena session.':
    'Arena wird im nicht-interaktiven Modus nicht untersttzt. Verwenden Sie den interaktiven Modus, um eine Arena-Sitzung zu beenden.',
  'Arena is not supported in non-interactive mode.':
    'Arena wird im nicht-interaktiven Modus nicht untersttzt.',
  ...
  'Arena requires at least 2 models. Use --models model1,model2 to specify.':
    'Arena bentigt mindestens 2 Modelle. Verwenden Sie --models model1,model2 zur Angabe.',
  'Arena started with {{count}} agents on task: "{{task}}"\nModels:\n{{modelList}}':
    'Arena mit {{count}} Agents fr Aufgabe "{{task}}" gestartet\nModelle:\n{{modelList}}',
  ...
  'Loading suggestions...': 'Vorschlge werden geladen...',
  'Show context window usage breakdown. Use "/context detail" for per-item breakdown.':
    'Die Aufschlsselung der Nutzung des Kontextfensters anzeigen. Fr Details pro Element "/context detail" verwenden.',
  'Show per-item context usage breakdown.':
    'Die Aufschlsselung der Kontextnutzung pro Element anzeigen.',

  // === Missing key backfill ===
  'for shell mode': 'fr Shell-Modus',
  'for commands': 'fr Befehle',
  'for file paths': 'fr Dateipfade',
  'to clear input': 'zum Leeren der Eingabe',
  'to cycle approvals': 'zum Wechseln der Freigaben',
  'to quit': 'zum Beenden',
  'for newline': 'fr Zeilenumbruch',
  'to clear screen': 'zum Leeren des Bildschirms',
  'to search history': 'zum Durchsuchen des Verlaufs',
  'to paste images': 'zum Einfgen von Bildern',
  'for external editor': 'fr externen Editor',
  ...
  'Press c to copy the authorization URL to your clipboard.':
    'Drcken Sie c, um die Autorisierungs-URL in die Zwischenablage zu kopieren.',
  'Copy request sent to your terminal. If paste is empty, copy the URL above manually.':
    'Kopieranfrage an Ihr Terminal gesendet. Wenn das Einfgen leer ist, kopieren Sie die URL oben manuell.',
  'Cannot write to terminal -- copy the URL above manually.':
    'Schreiben ins Terminal nicht mglich -- kopieren Sie die URL oben manuell.',
  'Tips:': 'Tipps:',
  'Retrying in {{seconds}} seconds... (attempt {{attempt}}/{{maxRetries}})':
    'Erneuter Versuch in {{seconds}} Sekunden... (Versuch {{attempt}}/{{maxRetries}})',
  'Press Ctrl+Y to retry': 'Drcken Sie Ctrl+Y, um es erneut zu versuchen',
  ...
  'Invalid API key. Coding Plan API keys start with "sk-sp-". Please check.':
    'Ungltiger API Key. Coding Plan API Keys beginnen mit "sk-sp-". Bitte prfen.',
  ...
  "Subsequent dreams may be skipped as locked until the next session's staleness sweep cleans the file.":
    'Weitere Dream-Lufe knnen als gesperrt bersprungen werden, bis der nchste Stale-Sweep der Sitzung die Datei bereinigt.',
  "The scheduler gate did not see this dream's timestamp; the next dream cycle may re-fire sooner than usual.":
    'Das Scheduler-Gate hat den Zeitstempel dieses Dream-Laufs nicht gesehen; der nchste Dream-Zyklus kann frher als blich erneut starten.',
